  ...
  const steps = [
    {
      number: '01',
      icon: MapPin,
      title: 'Legg inn boligen din',
      subtitle: 'Automatisk analyse og inntektsberegning.',
      color: 'gray',
    },
    {
      number: '02',
      icon: Phone,
      title: 'Kort veiledningssamtale',
      subtitle: 'Vi skreddersyr den mest lønnsomme utleiemodellen.',
      color: 'gray',
    },
    {
      number: '03',
      ...
      subtitle: 'Annonser, bilder og systemer settes opp for deg.',
      color: 'gray',
    },
    {
      number: '04',
      icon: Shield,
      title: 'Full drift – null stress',
      subtitle: 'Vi håndterer alt av gjester, nøkler, renhold og vedlikehold. Du beholder inntekten.',
      color: 'purple',
    },
  ];
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-10 sm:mb-12 md:mb-16">
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-3 sm:mb-4">
            Lønnsom utleie uten jobb – vi får deg i gang umiddelbart.
          </h2>
        </div>
